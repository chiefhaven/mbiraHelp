                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" id="featurebox_form" name="featurebox_form">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label"><?php echo e(lang('Description')); ?> <span class="text-red">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label"><?php echo e(lang('URL')); ?></label>
                                                ...
                                                <div>
                                                    ...
                                                    <span class="ms-1"><?php echo e(lang('Open in a new tab')); ?></span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small class="text-muted"><i><?php echo e(lang('Filesize should not be morethan 10MB', 'filesetting')); ?></i></small>
                                                <div>
...
<?php /**PATH C:\wamp64\www\mbiraHelp\resources\views/admin/featurebox/model.blade.php ENDPATH**/ ?>