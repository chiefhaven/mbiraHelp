<?php $__env->startSection('template_title'); ?>
    <?php echo e(trans('Step 2 | Permissions')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('title'); ?>
    <?php echo e(trans('Permissions')); ?>
...
<?php $__env->startSection('container'); ?>
    ...
    <?php if( ! isset($permissions['errors'])): ?>
        <div class="buttons">
            <a href="<?php echo e(route('SprukoAppInstaller::environment')); ?>" class="button">
                <?php echo e(trans('Configure Environment')); ?>
...
<?php echo $__env->make('installer.layouts.InstallerMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\helpdesk\resources\views/installer/permissions.blade.php ENDPATH**/ ?>