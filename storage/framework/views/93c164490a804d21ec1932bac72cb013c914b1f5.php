<?php $__env->startSection('template_title'); ?>
    <?php echo e(trans('Step 1 | Server Requirements')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('title'); ?>
    <?php echo e(trans('Server Requirements')); ?>
...
<?php $__env->startSection('container'); ?>
    ...
    <div class="buttons">
        <a class="button" href="<?php echo e(route('SprukoAppInstaller::permissions')); ?>">
            <?php echo e(trans('Check Permissions')); ?>
...
<?php echo $__env->make('installer.layouts.InstallerMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\helpdesk\resources\views/installer/requirement.blade.php ENDPATH**/ ?>